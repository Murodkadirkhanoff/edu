                                        ...
                                        <a class="text-body" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <p class="mb-3 text-body">Krisitn Watsan like your comment on course Javascript
                                                        Introduction!</p>
                                                    <span class="fs-6">
                                          <span>
                                        ...
                                        <a class="text-body" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <p class="mb-3 text-body">You earn new certificate for complete the Javascript Beginner
                                                        course.</p>
                                                    <span class="fs-6">
                                          <span>
            ...
            <li class="dropdown ms-2 d-inline-block position-static">
                ...
                <div class="dropdown-menu dropdown-menu-end position-absolute mx-3 my-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{route('social-profiles')}}">
