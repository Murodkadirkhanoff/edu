    ...
    <div class="container-fluid px-0">
            ...
            <div class="dropdown d-none d-md-block">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    @foreach(\App\Models\Category::whereNull('parent_id')->get() as $category)
                        ...
                        <li class="dropdown-submenu {{ $hasChildren ? 'dropend' : '' }}">
                            {{ $category->title }}
        ...
        <div class="order-lg-3">
            <div class="d-flex align-items-center">
                ...
                <a href="{{route('login')}}" class="btn btn-outline-primary ms-2 d-none d-lg-block">Sign in</a>
                <a href="../../pages/sign-up.html" class="btn btn-primary ms-2 d-none d-lg-block">Sign up</a>

                @role(\App\Enums\Roles::INSTRUCTOR->value)
                <a href="{{ route('instructor.dashboard') }}" class="btn btn-primary ms-2 d-none d-lg-block">Instructor
                    Dashboard</a>
                @endrole
                <!-- Button -->
                <button
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="../../pages/student-quiz-attempt.html">Quiz
                                                Attempt</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="../../pages/student-quiz-start.html">Quiz
                                                Single</a>
                                        </li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="../../pages/my-certificate.html">My
                                                Certificate</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="../../pages/learning-single.html">Learning
                                                Single</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="../../pages/learning-path-single.html">Learning
                                                Path Single</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="../../pages/project-blank.html">Project
                                                Blank</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="../../pages/dashboard-project.html">Dashboard
                                                Project</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="../../pages/project-single.html">Project
                                                Single</a>
                                        </li>
                                    </ul>
                                </li>
