            ...
            <div class="container my-lg-4">
                <div class="row">
                    <div class="offset-lg-2 col-lg-8 col-md-12 col-12 mb-8">
                        ...
                        <!-- para -->
                        <p class="h2 mb-3">
                            We’re building the best next-generation interactive bootstrap based UI Kit design tool for
                            developers, engineers, Full-Stack developer, and digital agency.
                        </p>
                        <p class="mb-0 h4 text-body lh-lg">
                            Geeks provide clean and consistent page designs to help you to create beautiful looking
                            contents. Geek is feature-rich components and beautifully designed pages that
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 offset-right-md-6">
                        ...
                        <!-- para -->
                        <p class="lead">Geeks is the leading global marketplace for teaching and learning, connecting
                            millions of students to the skills they need to succeed.</p>
                    </div>
            ...
            <div class="container my-lg-8">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-12 mb-6">
                        ...
                        <p class="lead">Our core values are the fundamental beliefs of a person or organization geeks
                            academy. We help people understand the difference between right and wrong.</p>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body p-5">
                                ...
                                <div class="mb-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                         class="bi bi-mortarboard text-primary" viewBox="0 0 16 16">
                                        <path
                                ...
                                <p class="mb-0">Quis cursus turpis in habitant sagittis amet dolor malesuada ut.
                                    Volutpat nunc id blanvolutpat nunc.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <div class="card mb-4 mb-lg-0">
                            ...
                            <div class="card-body p-5">
                                ...
                                <div class="mb-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                         class="bi bi-graph-up-arrow text-primary" viewBox="0 0 16 16">
                                        <path
                                            fill-rule="evenodd"
            ...
            <div class="container my-lg-8">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-12 mb-8">
                        ...
                        <!-- lead -->
                        <p class="lead mb-5">
                            Want to work with some of the best global talent and build a tool used by all the companies
                            you know and love? Join the Geeks team and help shape the future of design.
                        </p>
                        <!-- btn -->
                ...
                <div class="row">
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-1.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="one">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-2.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="two">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-3.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="three">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-4.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="four">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-5.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="five">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-6.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="six">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-7.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="seven">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-8.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="eight">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-9.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="eleven">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            ...
                            <img src="../assets/images/avatar/avatar-10.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="twelve">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            <!-- avatar -->
                            <img src="../assets/images/avatar/avatar-11.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="thirteen">
                            <!-- text -->
                    ...
                    <div class="col-md-2 col-3">
                        <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
                            <!-- avatar -->
                            <img src="../assets/images/avatar/avatar-12.jpg" alt="avatar"
                                 class="imgtooltip img-fluid rounded-circle" data-template="fourteen">
                            <!-- text -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        ...
                        <div class="pt-6 pt-lg-0">
                            ...
                            <p class="text-white-50 mb-4 lead">
                                ...
                                supporting our employee professional development and well-being.
                            </p>
                            <!-- btn -->
