                ...
                <div class="offset-xl-1 col-xl-5 col-lg-6 col-md-12 col-12">
                    <div class="py-8 me-xl-8 pe-xl-8">
                        ...
                        <div>
                            ...
                            <p class="lead text-dark">Fill in the form to the right to get in touch with someone on our
                                team, and we will reach out shortly.</p>
                            <div class="mt-8 fs-4">
                                <p class="mb-4">
                        ...
                        <div>
                            ...
                            <form class="row needs-validation" novalidate>
                                ...
                                <div class="mb-3 col-12 col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="last name" id="fname"
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <textarea class="form-control" id="messages" rows="3"
